...
public class MinCostToConnectAllPointsTests
{
    ...
    public void Solve_Example1_Returns20()
    {
        ...
        Assert.Equal(20, MinCostToConnectAllPoints.Solve(points));
    }
    ...
    public void Solve_Example2_Returns18()
    {
        ...
        Assert.Equal(18, MinCostToConnectAllPoints.Solve(points));
    }
    ...
    {
        int[][] points = [[0, 0], [1, 1]];
        Assert.Equal(2, MinCostToConnectAllPoints.Solve(points));
    }
    ...
    {
        int[][] points = [[0, 0]];
        Assert.Equal(0, MinCostToConnectAllPoints.Solve(points));
    }
}
